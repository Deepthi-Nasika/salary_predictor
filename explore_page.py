...
def shorten_categories(categories, cutoff):
    '''
    Shorten categories to fit the threshold
    '''
    categorical_map = {}
...
def show_explore_page():
    ...
    ax1.pie(data, labels=data.index, autopct="%1.1f%%", shadow=True, startangle=90, textprops={'fontsize': 5})
    ...
    st.write("""#### Data points from different countries""")
    st.pyplot(fig1)
